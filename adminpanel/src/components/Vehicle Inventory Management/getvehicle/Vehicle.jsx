...
const Vehicle = () => {
  ...
  const csvData = [
    ...
    ["Available Vehicles", Object.keys(vehicleAvailability["Available"]).length],
    ["Rented Vehicles", Object.keys(vehicleAvailability["Rented"]).length], 
    ["Not Available Vehicles", Object.keys(vehicleAvailability["Not Available"]).length], 
    ["Vehicle Type", "Count"],
    ...Object.entries(vehicleCategorys), 
    [], 
